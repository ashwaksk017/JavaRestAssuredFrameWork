...
public final class SchemaValidator {
    ...
    public static void validateOpenApi(Response response, String definitionName) {
        com.ak.api.openapi.OpenApiModels.assertMatchesDefinition(response, definitionName);
    }

    public static boolean matchesOpenApi(Response response, String definitionName) {
        return com.ak.api.openapi.OpenApiModels.matchesDefinition(response, definitionName);
    }
