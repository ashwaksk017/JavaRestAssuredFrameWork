...
public final class SchemaValidator {
    ...
    /**
     * Validate a body against a named Swagger {@code definitions} model in
     * {@code openapi/ProgramAccounts-1.0.71.yaml}. Uses the same
     * json-schema-validator as {@link #validate}.
     */
    public static void validateOpenApi(Response response, String definitionName) {
        com.hi.api.openapi.OpenApiModels.assertMatchesDefinition(response, definitionName);
    }

    public static boolean matchesOpenApi(Response response, String definitionName) {
        return com.hi.api.openapi.OpenApiModels.matchesDefinition(response, definitionName);
    }
