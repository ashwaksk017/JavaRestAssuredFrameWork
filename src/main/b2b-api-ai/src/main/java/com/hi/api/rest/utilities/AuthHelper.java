...
public final class AuthHelper {
    ...
    public static void primeClientCredentialsToken(Map<String, String> ctx) {
        ...
        String cached = TokenCache.getAccessToken();
        if (cached != null && !cached.isEmpty()) {
            ctx.put("accessToken", cached);
            LOG.info("AuthHelper: primed ctx.accessToken from TokenCache");
            return;
        }
        ...
        try {
            ...
            TokenCache.putAccessToken(token);
