...
public class FrameworkPartialGapsTest {
    ...
    public void domainApis_routesGuestCallsThroughGuestApi() {
        ...
        com.ak.api.domain.DomainApis domain = com.ak.api.domain.DomainApis.bind(raw);
        Assert.assertEquals(com.ak.api.domain.DomainApis.receiverFor("hHonorsEnroll"), "guests");
        Assert.assertEquals(com.ak.api.domain.DomainApis.receiverFor("createProgramAccount"), "accounts");
        Assert.assertEquals(com.ak.api.domain.DomainApis.receiverFor("validateMemberTOTP"), "members");
        Assert.assertEquals(com.ak.api.domain.DomainApis.receiverFor("tokenRequest"), "client");

        Assert.assertSame(raw, com.ak.api.domain.DomainApis.unwrapRaw(domain.client()));
        Assert.assertSame(raw, com.ak.api.domain.DomainApis.unwrapRaw(raw));
    ...
    private static final class RecordingClient implements com.ak.api.support.ImportedRestClient {
        boolean sawGuestApi;
