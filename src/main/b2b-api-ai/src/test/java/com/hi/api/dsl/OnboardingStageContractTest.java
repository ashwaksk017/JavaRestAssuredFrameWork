...
public class OnboardingStageContractTest {
    ...
    public void dbWithoutAConfiguredDatabaseFailsAtTheDbStep() throws Exception {
        ...
        Assert.assertEquals(com.hi.api.db.Db.DID_NOT_RUN, -1,
        ...
        try {
            if (com.hi.api.db.Db.isConfigured()) {
                return;
            }
            Assert.assertEquals(
                    com.hi.api.db.Db.executeTranslated("UPDATE account SET x=1",
                            new java.util.HashMap<>(), new java.util.HashMap<>()),
                    com.hi.api.db.Db.DID_NOT_RUN,
