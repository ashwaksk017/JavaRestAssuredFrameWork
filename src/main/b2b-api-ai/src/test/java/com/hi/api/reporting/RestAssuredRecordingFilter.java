...
public class RestAssuredRecordingFilter implements Filter {
    ...
    public Response filter(FilterableRequestSpecification requestSpec,
        ...
        String step = com.hi.api.rest.utilities.LastExchange.pendingStep();
        ...
        if (response.statusCode() == 401
                && "oauth2".equalsIgnoreCase(com.hi.api.config.Config.authType())) {
            com.hi.api.auth.AuthUtilities.invalidateOauth2Cache();
        }
    ...
    private static void logAuthDiagnostic(FilterableRequestSpecification requestSpec,
        ...
        if (com.hi.api.rest.utilities.AuthDiagnostics.isExpectedStatus(code)) {
        ...
        com.hi.api.rest.utilities.AuthDiagnostics.record("header: " + bucket);
    }
