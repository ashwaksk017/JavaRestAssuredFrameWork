...
public class SuiteNameTest {
    ...
    @Description("""
            ...
            com.hi.api.rest.manual.client.ManualClient, because a bare name
            ...
            suite `com.hi.api.rest.manual.client.manual` -- no SuiteCleanup
    ...
    public void aFullyQualifiedClientNameDerivesItsSimpleSuite() {
        Assert.assertEquals(
                SuiteName.fromClientSimpleName(
                        "com.hi.api.rest.manual.client.ManualClient"),
                "manual",
        ...
        Assert.assertEquals(
                SuiteName.fromClientSimpleName(
                        "com.hi.api.rest.clients." + "FooClient"),
                "foo");
        ...
        Assert.assertNull(SuiteName.fromClientSimpleName("com.hi.api.rest.Foo"));
        Assert.assertNull(SuiteName.fromClientSimpleName("com.hi.api.rest.Client"));
    }
