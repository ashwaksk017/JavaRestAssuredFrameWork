...
import com.hi.api.auth.AuthUtilities;
import com.hi.api.config.Config;
import com.hi.api.reporting.RestAssuredRecordingFilter;
import com.hi.api.reporting.TestInvocations;
import com.hi.api.rest.utilities.RestLoggerUtilityDataHolder;
import com.hi.api.rest.utilities.RestUtilities;

import com.hi.api.reporting.AllureRedactingFilter;
...
public abstract class BaseApiTest {
    ...
    private static void primeManagedDomainsFromDb() {
        ...
        java.util.List<String> domains =
                com.hi.api.db.repo.AccountRulesRepository.domainsByReason(reason);
        if (domains.isEmpty()) {
    ...
    public void newTestHolder() {
        ...
        com.hi.api.rest.utilities.LastExchange.clear();
        ...
        com.hi.api.support.TestThreadState.bind(softAssert, holder);
        holders.add(holder);
        ...
        com.hi.api.reporting.ReportBuffer.reset();
    ...
    public void assertAll(ITestResult result) {
        SoftAssert sa = com.hi.api.support.TestThreadState.softAssert();
        if (sa == null) {
            sa = softAssert;
        }
        if (sa == null) return;
        try {
            ...
            com.hi.api.support.TestThreadState.clear();
        }
    }
    ...
    protected com.hi.api.data.Expected expected(java.util.Map<String, String> row) {
        return com.hi.api.data.Expected.from(row == null ? null : row.get("expected"));
    }
