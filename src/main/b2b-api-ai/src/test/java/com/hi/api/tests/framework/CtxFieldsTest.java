...
public class CtxFieldsTest {
    ...
    public void mapJsonValues_fallsBackToACaseInsensitiveKey() throws Exception {
        ...
        String body = com.hi.api.rest.utilities.RestUtilities.mapJsonValues(
    ...
    public void mapJsonValues_exactKeyWinsAndAmbiguityIsNotGuessed() throws Exception {
        ...
        String bodyCi = com.hi.api.rest.utilities.RestUtilities.mapJsonValues(
        ...
        String body2 = com.hi.api.rest.utilities.RestUtilities.mapJsonValues(
