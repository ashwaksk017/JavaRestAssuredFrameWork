...
| see which phases the DSL offers | [Onboarding phase catalog](#onboarding-phase-catalog) |
| understand convert-time vs run-time | [Framework architecture](#framework-architecture) |
...
`CreateTestCase.md` stays a separate file on purpose: a dozen source files,
including Java javadoc, point at it by name and section.
